...
gulp.task("clean:cleanExceptTests", () =>
	del(["clean:vsix", "out", "!out/test"])
);
gulp.task("clean:vsix", () => del(["*.vsix"]));
gulp.task("clean:out", () =>
	del(["out/**", "!out", "!out/client_renderer/**", "!**/*nls.*.json"])
);
...
gulp.task(
	...
	gulp.series(
		...
		gulp.parallel(
			...
			"webpack-extension-node",
			"webpack-extension-web"
		),
...
gulp.task(
	"prePublishNonBundle",
	gulp.parallel("compile", "compile-webviews-dev", "compile-webextension")
);
