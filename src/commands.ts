...
export interface ICommandNameArgumentTypeMapping {
	...
	[DSCommands.InterruptKernel]: [
		{ notebookEditor: { notebookUri: Uri } } | undefined,
	];
	[DSCommands.RestartKernel]: [
		{ notebookEditor: { notebookUri: Uri } } | undefined,
	];
	[DSCommands.RestartKernelAndRunAllCells]: [
		{ notebookEditor: { notebookUri: Uri } } | undefined,
	];
	[DSCommands.RestartKernelAndRunUpToSelectedCell]: [
		{ notebookEditor: { notebookUri: Uri } } | undefined,
	];
	...
	["setContext"]:
		...
		| ["jupyter.vscode.channel", Channel];
	...
	[DSCommands.NativeNotebookExport]: [
		Uri | undefined | { notebookEditor: { notebookUri: Uri } },
	];
	[DSCommands.LatestExtension]: [string];
	[DSCommands.EnableLoadingWidgetsFrom3rdPartySource]: [];
	[DSCommands.ShowDataViewer]: [
		IJupyterVariable | IShowDataViewerFromVariablePanel,
	];
