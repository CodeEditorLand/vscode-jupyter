...
export function trackDisplayDataForExtension(
	extension: string,
	kernel: IKernelSession,
...
export function isDisplayIdTrackedForAnExtension(
	kernel: IKernelSession,
	displayId: string,
) {
	const extensionMap =
...
export function unTrackDisplayDataForExtension(
	kernel: IKernelSession,
	displayId: string,
) {
	const extensionMap =
