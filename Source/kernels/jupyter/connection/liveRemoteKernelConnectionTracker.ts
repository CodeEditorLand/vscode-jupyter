...
export const mementoKeyToTrackRemoveKernelUrisAndSessionsUsedByResources =
	"removeKernelUrisAndSessionsUsedByResources";

type ServerId = string;
type KernelId = string;
type UriString = string;
type UriSessionUsedByResources = Record<
	ServerId,
	Record<KernelId, UriString[]>
>;
