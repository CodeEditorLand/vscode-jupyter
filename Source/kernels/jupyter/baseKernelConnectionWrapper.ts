 ...
 */
export abstract class BaseKernelConnectionWrapper
	implements Kernel.IKernelConnection
{
	...
	public get serverSettings() {
		return (this.possibleKernelConnection || this._previousKernelConnection)
			.serverSettings;
	}
	public readonly disposed = new Signal<this, void>(this);
	// private _isRestarting?: boolean;
	protected abstract get possibleKernelConnection():
		| undefined
	...
	public get isDisposed(): boolean {
		return this.possibleKernelConnection
			? this.possibleKernelConnection?.isDisposed === true
			: true;
	}
	...
	public get connectionStatus(): Kernel.ConnectionStatus {
		return (
			this.possibleKernelConnection?.connectionStatus || "disconnected"
		);
	}
