...
suite("JupyterKernelService", () => {
	...
	const kernels: LocalKernelConnectionMetadata[] = [
		...
		PythonKernelConnectionMetadata.create({
			kernelSpec: {
				specFile:
					"C:\\Users\\Rich\\.local\\share\\jupyter\\kernels\\python3.json",
				name: "python3",
				argv: [
					os.platform() === "win32"
						? "/usr/bin/python3.exe"
		...
		LocalKernelSpecConnectionMetadata.create({
			kernelSpec: {
				specFile:
					"C:\\Users\\Rich\\.local\\share\\jupyter\\kernels\\julia.json",
				name: "julia",
				argv: ["/usr/bin/julia"],
				language: "julia",
				executable: "/usr/bin/julia",
		...
		PythonKernelConnectionMetadata.create({
			kernelSpec: {
				specFile:
					"C:\\Users\\Rich\\.local\\share\\jupyter\\kernels\\python2.json",
				name: "python2",
				argv: [
					os.platform() === "win32"
						? "/usr/bin/python.exe"
		...
		PythonKernelConnectionMetadata.create({
			kernelSpec: {
				specFile:
					"/usr/don/home/envs/sample/share../../kernels/sampleEnv/kernel.json",
				name: "sampleEnv",
				argv: [
					os.platform() === "win32"
		...
		LocalKernelSpecConnectionMetadata.create({
			kernelSpec: {
				specFile:
					"/usr/don/home/envs/sample/share../../kernels/sampleEnvJulia/kernel.json",
				name: "sampleEnvJulia",
