...
suite("Jupyter Connection Waiter", async () => {
	...
	const dsSettings: IJupyterSettings = {
		jupyterLaunchTimeout: 10_000,
	} as any;
	...
	test("Successfully gets connection info", async () => {
		...
		observableOutput.fire({
			source: "stderr",
			out: "Jupyter listening on http://localhost2:2",
		});
