...
suite("kernel Process", () => {
	[
		"watiForPortsToBeUsed experiments disabled",
		"watiForPortsToBeUsed experiments enabled",
	].forEach((experimentMsg) => {
		suite(experimentMsg, () => {
			...
			let observableOutput: ReturnType<
				typeof createObservable<Output<string>>
			>;
			...
			setup(() => {
				...
				kernelEnvVarsService =
					mock<KernelEnvironmentVariablesService>();
