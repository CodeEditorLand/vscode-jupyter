...
const _escapeRegExp =
	require("lodash/escapeRegExp") as typeof import("lodash/escapeRegExp"); // NOSONAR
 ...
 */
@injectable()
export class InteractiveWindowTracebackFormatter
	implements ITracebackFormatter
{
	constructor(
	...
	private modifyTracebackFrameIPython8(
		...
		if (
			inputMatch &&
			inputMatch.groups?.executionCount &&
			...
			cellMatch &&
			cellMatch.groups?.executionCount &&
