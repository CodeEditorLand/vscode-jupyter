...
const runCurrentandAllBelowTitle =
...
export class CodeLensFactory implements ICodeLensFactory {
	...
	constructor(
		...
		@inject(ICellRangeCache)
		private readonly cellRangeCache: ICellRangeCache,
	) {
	...
	private getCodeLensCacheData(document: TextDocument): CodeLensCacheData {
		...
		if (
			...
			const storage = this.generatedCodeStorageFactory.get({
