...
export class ExportInterpreterFinder {
	...
	public async getExportInterpreter(
		...
		if (selectedJupyterInterpreter) {
			if (
				await this.checkNotebookInterpreter(selectedJupyterInterpreter)
			) {
