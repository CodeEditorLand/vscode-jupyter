...
/**
 * Specific implementation of INbConvertExport for exporting to HTML
 */
@injectable()
export class ExportToHTML implements INbConvertExport {
	constructor(
		@inject(IExportBase) protected readonly exportBase: IExportBase
	) {}
	public async export(
		...
		await this.exportBase.executeCommand(
			sourceDocument,
			target,
			ExportFormat.html,
			interpreter,
