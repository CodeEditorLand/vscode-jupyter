...
} from "../../../../platform/common/persistentState";
...
suite("ipywidget - Widget Script Source Provider", () => {
	...
	[true, false].forEach((localLaunch) => {
		suite(
			localLaunch ? "Local Jupyter Server" : "Remote Jupyter Server",
			() => {
				setup(() => {
					if (localLaunch) {
