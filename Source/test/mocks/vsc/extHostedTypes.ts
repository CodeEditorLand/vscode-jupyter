...
export namespace vscMockExtHostedTypes {
	...
	export class WorkspaceEdit implements vscode.WorkspaceEdit {
		...
		set(
			uri: vscode.Uri,
			edits: [NotebookEdit, vscode.WorkspaceEditEntryMetadata][]
		): void;
	...
	export class CodeActionKind {
		...
		public static readonly QuickFix =
			CodeActionKind.Empty.append("quickfix");
		public static readonly Refactor =
			CodeActionKind.Empty.append("refactor");
	...
	export class RelativePattern implements IRelativePattern {
		...
		constructor(
			base: vscode.WorkspaceFolder | vscUri.URI | string,
			pattern: string
		) {
	...
	export class NotebookRendererScript {
		...
		constructor(
			...
			this.provides =
				typeof provides === "string" ? [provides] : provides;
		}
	}
	...
	export class NotebookEdit {
		...
		static updateCellMetadata(
			index: number,
			_newCellMetadata: { [key: string]: any }
		): NotebookEdit {
		 ...
		 */
		static updateNotebookMetadata(_newNotebookMetadata: {
			[key: string]: any;
		}): NotebookEdit {
