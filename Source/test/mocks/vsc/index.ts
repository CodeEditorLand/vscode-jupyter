...
export namespace vscMock {
	...
	export class MarkdownString {
		...
		public appendText(value: string): MarkdownString {
			...
			this.value += (
				this.supportThemeIcons ? escapeCodicons(value) : value
	...
	export class CodeActionKind {
		...
		public static readonly RefactorExtract: CodeActionKind =
			new CodeActionKind("refactor.extract");

		public static readonly RefactorInline: CodeActionKind =
			new CodeActionKind("refactor.inline");

		public static readonly RefactorRewrite: CodeActionKind =
			new CodeActionKind("refactor.rewrite");
		...
		public static readonly SourceFixAll: CodeActionKind =
			new CodeActionKind("source.fix.all");
		public static readonly RefactorMove: CodeActionKind =
			new CodeActionKind("refactor.move");
