...
suite(
	"VSCode Intellisense Notebook and Interactive Goto Definition @lsp",
	function () {
		...
		test.skip("Define something in another cell and goto it", async () => {
			...
			const onDidSwitchNotebooks = createEventHandler(
				vscode.window,
		...
		test.skip("Import pandas and goto it", async () => {
			...
			const onDidSwitchActiveEditor = createEventHandler(
				vscode.window,
