...
export class MockQuickPick implements QuickPick<QuickPickItem> {
	...
	private didChangeValueEmitter: EventEmitter<string> =
		new EventEmitter<string>();
	private didTriggerItemButton: EventEmitter<
		QuickPickItemButtonEvent<QuickPickItem>
	> = new EventEmitter<QuickPickItemButtonEvent<QuickPickItem>>();
	private didAcceptEmitter: EventEmitter<void> = new EventEmitter<void>();
	private didTriggerButtonEmitter: EventEmitter<QuickInputButton> =
		new EventEmitter<QuickInputButton>();
	private didChangeActiveEmitter: EventEmitter<QuickPickItem[]> =
		new EventEmitter<QuickPickItem[]>();
	private didChangeSelectedEmitter: EventEmitter<QuickPickItem[]> =
		new EventEmitter<QuickPickItem[]>();
