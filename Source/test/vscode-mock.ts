...
mockedVSCode.l10n = {
	...
	t: (
		arg1:
			| string
			| { message: string; args?: string[] | Record<string, string> },
		...
		if (typeof arg1 === "string") {
			...
			if (
				typeof restOfArguments === "object" &&
				!Array.isArray(restOfArguments)
			) {
				throw new Error(
					"Records for l10n.t() are not supported in the mock"
				);
			}
...
mockedVSCode.PortAutoForwardAction =
	vscodeMocks.vscMockExtHostedTypes.PortAutoForwardAction;
mockedVSCode.PortAttributes = vscodeMocks.vscMockExtHostedTypes.PortAttributes;
mockedVSCode.NotebookRendererScript =
	vscodeMocks.vscMockExtHostedTypes.NotebookRendererScript;
...
mockedVSCode.QuickPickItemKind =
	vscodeMocks.vscMockExtHostedTypes.QuickPickItemKind;
(mockedVSCode as any).NotebookCellKind =
	vscodeMocks.vscMockExtHostedTypes.NotebookCellKind;
(mockedVSCode as any).NotebookRunState =
	vscodeMocks.vscMockExtHostedTypes.NotebookRunState;
...
(mockedVSCode as any).NotebookCellMetadata =
	vscodeMocks.vscMockExtHostedTypes.NotebookCellMetadata;
(mockedVSCode as any).NotebookCellMetadata =
	vscodeMocks.vscMockExtHostedTypes.NotebookCellMetadata;
(mockedVSCode as any).NotebookCellOutput =
	vscodeMocks.vscMockExtHostedTypes.NotebookCellOutput;
(mockedVSCode as any).NotebookCellOutputItem =
	vscodeMocks.vscMockExtHostedTypes.NotebookCellOutputItem;
(mockedVSCode as any).NotebookCellExecutionState =
	vscodeMocks.vscMockExtHostedTypes.NotebookCellExecutionState;
