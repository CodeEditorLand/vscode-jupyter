	...
	protected async loadWebview(
		...
		if (this.webview === undefined) {
			...
			const workspaceFolder =
				this.workspaceService.getWorkspaceFolder(cwd)?.uri;
	...
	protected async sendLocStrings() {
		const locStrings: LocalizedMessages = {
			...
			sliceMismatchedAxesError:
				localize.WebViews.sliceMismatchedAxesError,
			...
			variableExplorerNameColumn:
				localize.WebViews.variableExplorerNameColumn,
			variableExplorerTypeColumn:
				localize.WebViews.variableExplorerTypeColumn,
			variableExplorerCountColumn:
				localize.WebViews.variableExplorerCountColumn,
			variableExplorerValueColumn:
				localize.WebViews.variableExplorerValueColumn,
			collapseVariableExplorerLabel:
				localize.WebViews.collapseVariableExplorerLabel,
			...
			noRowsInVariableExplorer:
				localize.WebViews.noRowsInVariableExplorer,
			loadingRowsInVariableExplorer:
				localize.WebViews.loadingRowsInVariableExplorer,
