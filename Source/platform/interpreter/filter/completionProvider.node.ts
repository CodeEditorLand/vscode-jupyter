...
export class PythonEnvFilterCompletionProvider
	implements CompletionItemProvider, IExtensionSyncActivationService
{
	...
	constructor(
		...
		private readonly pythonExtChecker: IPythonExtensionChecker
	) {}
	...
	public static canProvideCompletions(
		...
		return (
			location.path[0] === "jupyter.kernels.excludePythonEnvironments" &&
