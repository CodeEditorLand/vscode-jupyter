...
type VariableViewPanelReducerFunctions<T> = {
	[P in keyof T]: T[P] extends never | undefined
		? VariableViewPanelReducerFunc
		: VariableViewPanelReducerFunc<T[P]>;
};

export type IVariableViewPanelActionMapping =
	VariableViewPanelReducerFunctions<IInteractiveWindowMapping> &
